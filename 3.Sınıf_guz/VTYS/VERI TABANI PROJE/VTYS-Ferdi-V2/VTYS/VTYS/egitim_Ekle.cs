...
namespace VTYS
{
    public partial class egitim_Ekle : Form
    {
        ...
        void ekle()
        {
            string BaglantiAdresi = "Data Source = DESKTOP-R9M819K\\MSSQLSERVERYENI; Initial Catalog = egitim; Integrated Security = True;";
        ...
        private void egitim_Ekle_Load(object sender, EventArgs e)
        {
        ...
        {
            string BaglantiAdresi = "Data Source = DESKTOP-R9M819K; Initial Catalog = egitim; Integrated Security = True;";
            SqlConnection Baglanti = new SqlConnection();
            Baglanti.ConnectionString = BaglantiAdresi;
